...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_eggnog_mapper.run_eggnog_mapper,
                             name='kb_eggnog_mapper.run_eggnog_mapper',
                             types=[dict])
        self.method_authentication['kb_eggnog_mapper.run_eggnog_mapper'] = 'required'  # noqa
